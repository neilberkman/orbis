defmodule Orbis.GNSS.SP3WriterTest do
  ...
  describe "Data.write_sp3/3" do
    setup do
      base =
        Path.join(System.tmp_dir!(), "orbis_sp3_write_#{System.unique_integer([:positive])}")
  ...
  describe "merge -> write -> re-read" do
    test "the written merged product covers the union of two centers", %{} do
      ...
      path =
        Path.join(System.tmp_dir!(), "orbis_merged_#{System.unique_integer([:positive])}.sp3")
