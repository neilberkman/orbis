# Tracks C+D campaign: honest centimeters beyond co-located baselines
...
tides, carrier wind-up where applicable) implemented honestly — i.e. each
...
gate as the truth metric: final criterion = orbis matches RTKLIB's fixed
