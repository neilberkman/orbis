defmodule RoverC2InnovationScreening202606 do
  ...
  @innovation_screen_sigmas [5.0, 10.0, 25.0]
  ...
  defp run_c2_exploration(opts, fixture_dir, work, results_path, report_path) do
    ...
    result = %{
      ...
      "work_dir" => work,
      "brief" => "/tmp/c2-screening-brief.md",
      ...
      "pooled" => stringify_keys(c2_pooled_summary(arcs))
    }
  ...
  defp c2_report_markdown(result, results_path) do
    ...
    [
      ...
      "- The measured path uses the Elixir sequential filter (`filter_kernel: :elixir`) with `innovation_screen_sigma` in #{Enum.map_join(@innovation_screen_sigmas, ", ", &fmt/1)} and `innovation_screen_min_rows: #{@innovation_screen_min_rows}`.",
