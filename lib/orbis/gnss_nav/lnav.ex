defmodule Orbis.GnssNav.LNAV do
  @moduledoc """
  ...
  *words*. Every word carries 24 source data bits (most significant first)
  ...
  `encode/2` and `decode/1` exchange an `Orbis.GnssNav.LNAV.Ephemeris` struct
  ...
  *semicircles* (and semicircles/second), the harmonic correction terms use
  ...
  ## Examples
      ...
      iex> Orbis.GnssNav.LNAV.word_length()
      30

      iex> Orbis.GnssNav.LNAV.subframe_length()
      300

      iex> Orbis.GnssNav.LNAV.preamble()
      139
  ...
  ## Examples
      ...
      iex> {:ok, sfs} = Orbis.GnssNav.LNAV.encode(Orbis.GnssNav.LNAV.Ephemeris.example(), tow: 12345)
      iex> Orbis.GnssNav.LNAV.tow(sfs[1])
      12345
  ...
  ## Examples
      ...
      iex> {:ok, sfs} = Orbis.GnssNav.LNAV.encode(Orbis.GnssNav.LNAV.Ephemeris.example(), tow: 0)
      iex> Orbis.GnssNav.LNAV.subframe_id(sfs[2])
      2
  ...
  returns `{:ok, %Orbis.GnssNav.LNAV.Ephemeris{}}`.
  """
