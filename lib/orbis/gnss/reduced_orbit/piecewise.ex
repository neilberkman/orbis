defmodule Orbis.GNSS.ReducedOrbit.Piecewise do
  @moduledoc """
  ...
  **not** orbit determination and **not** a substitute for SP3 or SGP4 — it is a
  ...
  matching the single-segment `Orbis.GNSS.ReducedOrbit.drift/3` report. Epochs outside
