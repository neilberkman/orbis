defmodule Orbis.GnssConstellation do
  @moduledoc """
  ...
  ## Examples
      ...
      ...> ]
      iex> {:ok, [record]} = Orbis.GnssConstellation.from_celestrak_omm(omms)
      iex> {record.system, record.prn, record.norad_id, record.sp3_id}
      {:gps, 3, 40294, "G03"}

      iex> record = %Orbis.GnssConstellation.Record{
      ...>   system: :gps,
      ...>   prn: 3,
      ...>   svn: nil,
      ...>   norad_id: 40294,
      ...
      ...>   source: %{}
      ...> }
      iex> Orbis.GnssConstellation.to_csv([record])
  ...
  The second argument may be a loaded `%Orbis.SP3{}` or a list of SP3/RINEX
  ...
  Render the canonical SP3/RINEX satellite token for a supported GNSS PRN.
      ...
      iex> Orbis.GnssConstellation.sp3_id(:gps, 7)
      "G07"
  """
