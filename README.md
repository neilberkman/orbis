...
| **GNSS positioning**       | Single-point positioning from SP3 or broadcast ephemeris — GPS, Galileo, BeiDou, GLONASS — plus single- and multi-epoch float-ambiguity carrier-phase positioning from SP3-backed ionosphere-free code/phase observations                            |
