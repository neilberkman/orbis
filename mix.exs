    ...
    [
      ...
      groups_for_modules: [
        ...
        "GNSS Positioning": [
          ...
          Orbis.GNSS.ReducedOrbit,
          Orbis.GNSS.ReducedOrbit.Piecewise,
          Orbis.GNSS.Constellation,
          Orbis.GNSS.Geometry,
          Orbis.GNSS.Observables,
          Orbis.GNSS.Velocity,
          Orbis.GNSS.QC,
          Orbis.GNSS.DGNSS,
          ...
          Orbis.GNSS.Time,
          Orbis.GNSS.Signal.CA,
          Orbis.GNSS.Signal.Correlator,
          Orbis.GNSS.Navigation.LNAV,
          Orbis.GNSS.Navigation.LNAV.Ephemeris
        ],
        "Data Sources": [
          Orbis.CelesTrak,
          Orbis.Constellation,
          Orbis.GNSS.Data,
          Orbis.GNSS.Data.Product,
          Orbis.GNSS.Data.Catalog,
          Orbis.GNSS.Data.Cache
        ],
        "Batch Analysis": [
          Orbis.Nx,
          Orbis.Nx.Geometry,
